...
public class fbCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*fbtoolbar= (Toolbar)findViewById(R.id.fbToolbar);
        setSupportActionBar(fbtoolbar);
        getSupportActionBar().setTitle(null);
        getSupportActionBar().setDisplayUseLogoEnabled(true);
        getSupportActionBar().setLogo(R.drawable.fblogo);*/



        mWebViewComments = (WebView) findViewById(R.id.fbCommentView);
    ...
    private void loadComments() {
        ...
        String html = "<!doctype html> <html lang=\"en\"> <head></head> <body> " +
                ...
                "<div class=\"fb-comments\" data-href=\"http://www.androidhive.info/2016/06/android-firebase-integrate-analytics/" + postUrl + "\" " +
                "data-numposts=\"5" + NUMBER_OF_COMMENTS + "\" data-order-by=\"reverse_time\">" +
                "</div> </body> </html>";
    ...
    public void onReceivedSs1Error (WebView view, SslErrorHandler handler,
        SslError error) {
        setLoading(false);
    }
